        ...
        try {
            ...
            if (prod && !prod.error) {
                setFormData({
                    ...
                    base_price: prod.base_price?.toString() || '0',
                    gender: prod.gender || '',
        ...
        try {
            ...
            const response = await fetch(`/api/products/${id}`, {
                ...
                body: JSON.stringify({
                    ...
                    images,   // Now syncing images through API
                    variants  // Now syncing variants through API
                })
            })
        ...
        <div className="bg-black min-h-screen pb-24">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-12">
                    <h1 className="text-4xl font-bold text-white tracking-tight uppercase">Edit Product</h1>
                </div>

                <form onSubmit={handleSubmit} className="space-y-8">
                    {/* General Info */}
                    <section className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-6">
                        <h2 className="text-lg font-bold border-b border-neutral-800 pb-3 font-mono uppercase tracking-widest text-xs">Basic Information</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    required
                                    type="number"
                                    className="input-field py-2 font-black"
                    ...
                    {/* Images */}
                    <section className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-6">
                        <h2 className="text-lg font-bold border-b border-neutral-800 pb-3 font-mono uppercase tracking-widest text-xs">Product Images</h2>
                    ...
                    <section className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 space-y-6">
                        <div className="flex justify-between items-center border-b border-neutral-800 pb-3">
                            <h2 className="text-lg font-bold font-mono uppercase tracking-widest text-xs">Variants</h2>
                            <button
                                type="button"
                        ...
                        <div className="space-y-4">
                            {variants.map((v, i) => (
                                <div key={i} className="flex gap-4 items-end">
                                    ...
                                    <div className="w-24">
                                        <label className="text-[10px] uppercase text-neutral-500 mb-1 block">Stock</label>
                                        <input
                                            type="number"
                                            className="input-field py-2"
                                            value={v.stock}
                    ...
                    <div className="flex gap-6">
                        ...
                        <button
                            type="button"
                            onClick={() => router.back()}
                            className="px-8 py-4 text-neutral-400 hover:text-white font-bold transition-colors uppercase tracking-widest text-xs"
                        >
                            Cancel
                        </button>
                    </div>
